package toby.spring.splearn.adapter;
...
import toby.spring.splearn.domain.member.DuplicateProfileException;
...
public class ApiControllerAdvice extends ResponseEntityExceptionHandler {
    ...
    public ProblemDetail handleException(Exception exception) {
        return getProblemDetail(INTERNAL_SERVER_ERROR,exception);
    }
